...
import CameraCard from '../components/UIRender/camera/CameraCard';
import CameraOpenVidu from '../components/UIRender/camera/CameraOpenVidu';
import DroneRender from '../components/UIRender/drone/DroneRender';
import DroneCard from '../components/UIRender/drone/DroneCard';
import WeatherBox from '../components/UIRender/WeatherBox';
import Header from '../components/common/Header';
import { cDroneColorKeys } from '../define';

const MuhanVwMap = dynamic(() => import('../components/map/MuhanVWMap2'), {
  ssr: false,
});
        ...
        cameras.map((v, i) => {
          ...
          return (
            ...
            <CameraCard
              ...
              drone={v}
              number={i}
              content={<CameraOpenVidu mySessionId={sessionId} />}
            />
          );
        })}
